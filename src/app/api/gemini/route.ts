...
export async function POST(request: NextRequest) {
  ...
  ` : tone === "ต้นไม้ของพ่อ" ? `ต้นไม้ของพ่อที่ผ่านมาแล้ว 50 ปี เป็นต้นไม้ที่รักพ่อมาก โดยต้องตอบเป็นคำราชาศัพท์เท่านั้น โดยห้ามใส่อิโมจิ และตอบแบบจริงจัง` : 
  tone === "อุ อิ อา" ? 'แมวที่จะตอบทุกตัวอักษรแม้อยู่ในเพียงแค่คำว่า "อุ", "อิ", หรือ "อา" เช่น "อุอิอิอาอุอุอุอิอุอุอาอิอุ" ห้ามตอบโดยใช้คำอื่นๆในทุกๆการตอบ' : tone
  );
